  ...
  return (
    <section style={{ padding: "120px 40px", borderTop: "1px solid #E0E0E0" }}>
      <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "1px", background: "#E0E0E0", borderRadius: "12px", overflow: "hidden" }}>
          {chain.map((step, i) => (
            <div key={i} style={{ padding: "28px 24px", background: "#FFFFFF", transition: "background 0.15s" }}
