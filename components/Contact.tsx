  ...
  return (
    <section style={{ padding: "120px 40px",  }}>
      <div style={{ maxWidth: "1200px", margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 2fr", gap: "80px", alignItems: "start" }}>
        ...
        <div>
          <h2 style={{ fontSize: "clamp(24px, 3vw, 36px)", fontWeight: 700, color: "#0A0A0A", lineHeight: 1.4, letterSpacing: "-0.02em", marginBottom: "14px" }}>
            {t("headline")}
          </h2>
          <p style={{ fontSize: "14px", color: "#666", lineHeight: 1.8, marginBottom: "28px" }}>{t("description")}</p>
          <a href="https://kr.linkedin.com/in/seungryongchang" target="_blank" rel="noopener noreferrer"
            style={{ display: "inline-flex", alignItems: "center", gap: "10px", padding: "14px 32px", borderRadius: "8px", fontSize: "15px", fontWeight: 500, background: "#B8860B", color: "#FFFFFF", textDecoration: "none", transition: "opacity 0.15s" }}
